...
export function NavbarPremium({ 
  ...
  return (
    <nav 
      className={`premium-nav fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        scrolled 
          ? isDark 
    ...
    >
      <div className="container mx-auto px-4">
        <div className="premium-nav-row flex items-center justify-between h-20">
          {/* Logo */}
          <button 
        ...
        {mobileMenuOpen && (
          <div
            ...
            className="premium-mobile-menu lg:hidden py-6 border-t border-border/50 animate-slide-up"
          >
