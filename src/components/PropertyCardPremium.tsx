...
export function PropertyCardPremium({ property, onViewDetails }: PropertyCardPremiumProps) {
  ...
  return (
    <div className="property-card-premium group relative bg-card border border-border rounded-2xl overflow-hidden hover-lift animate-fade-in">
      {/* Image Container */}
      <div className="relative h-64 overflow-hidden image-zoom bg-muted">
        ...
        {/* Action Buttons */}
        <div className="property-card-actions absolute top-4 right-4 flex gap-2 opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-y-2 group-hover:translate-y-0 z-10">
          <Button
            size="icon"
            variant="secondary"
      ...
      >
        ...
        {property.category !== 'land' ? (
          <div className="property-card-specs flex items-center gap-4 mb-4 text-sm text-muted-foreground">
        ...
        {/* Agent Info */}
        {property.agent && (
          <div className="property-card-agent flex items-center justify-between pt-4 border-t border-border">
            <div className="property-card-agent-info flex items-center gap-2">
            ...
            <Button 
              ...
              className="property-card-view-btn group-hover:shadow-lg group-hover:shadow-primary/20 transition-all"
            >
              View Details
            </Button>
          </div>
