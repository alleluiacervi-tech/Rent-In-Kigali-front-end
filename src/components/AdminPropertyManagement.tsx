  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="bg-white border-b border-border">
        <div className="container mx-auto px-4 py-6">
          <div className="admin-header-row flex items-center justify-between">
            ...
            <Button onClick={() => onNavigate('admin-add-property')} className="admin-header-cta gap-2">
      ...
      <div className="container mx-auto px-4 py-8">
        <Card>
          <CardHeader>
            <div className="admin-management-header flex items-center justify-between">
              <CardTitle>All Properties ({filteredProperties.length})</CardTitle>
              <div className="admin-search-wrap w-72">
