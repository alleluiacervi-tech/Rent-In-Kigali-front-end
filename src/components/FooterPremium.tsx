    ...
    <footer className="bg-muted border-t border-border">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="space-y-3">
              <div className="footer-contact-item flex items-center gap-3 text-sm">
      ...
      <div className="border-t border-border">
        <div className="container mx-auto px-4 py-6">
          <div className="footer-bottom-row flex flex-col md:flex-row items-center justify-between gap-6">
            {/* Social Links */}
            <div className="footer-social-wrap flex items-center gap-3">
            ...
            {/* Legal Links */}
            <div className="footer-legal-links flex flex-wrap items-center gap-6 text-sm text-muted-foreground">
