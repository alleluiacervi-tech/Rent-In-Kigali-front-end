...
export function FeaturedCarousel({ properties, onViewDetails }: FeaturedCarouselProps) {
  ...
  return (
    <div className="relative h-[400px] md:h-[450px] overflow-hidden rounded-xl group shadow-lg">
      ...
      <button
        onClick={prevSlide}
        className="absolute left-3 top-1/2 -translate-y-1/2 bg-white/10 backdrop-blur-sm hover:bg-white/20 text-white p-2.5 rounded-full opacity-0 group-hover:opacity-100 transition-opacity z-10"
      >
        <ChevronLeft className="h-5 w-5" />
      </button>
      <button
        onClick={nextSlide}
        className="absolute right-3 top-1/2 -translate-y-1/2 bg-white/10 backdrop-blur-sm hover:bg-white/20 text-white p-2.5 rounded-full opacity-0 group-hover:opacity-100 transition-opacity z-10"
      >
      ...
      <div className="absolute bottom-0 left-0 right-0 p-6 md:p-8 z-10">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex items-center gap-4 md:gap-6 mb-4 text-white text-sm md:text-base">
      ...
      {/* Dot Indicators */}
      <div className="absolute bottom-6 md:bottom-8 right-6 md:right-8 flex gap-1.5 z-10">
