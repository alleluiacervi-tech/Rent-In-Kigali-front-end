  ...
  return (
    <>
      ...
      <motion.div
        ...
        className="whatsapp-chat-root fixed bottom-6 right-6 z-50"
      >
        <AnimatePresence>
          {isExpanded && (
            <motion.div
              ...
              className="whatsapp-chat-panel absolute bottom-20 right-0 bg-white rounded-lg shadow-2xl p-4 w-64 mb-2"
            >
              <button
        ...
        >
          ...
          {!isExpanded && (
            <motion.div
              ...
              className="whatsapp-chat-tooltip absolute right-full mr-3 top-1/2 -translate-y-1/2 bg-gray-900 text-white px-3 py-2 rounded-lg text-sm whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none"
            >
