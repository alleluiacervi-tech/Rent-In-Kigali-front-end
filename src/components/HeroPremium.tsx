...
export function HeroPremium({ onSearch, onNavigate }: HeroPremiumProps) {
  ...
  return (
    <div className="hero-premium relative min-h-[90vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-20 container mx-auto px-4 pt-20 pb-16">
        <div className="max-w-4xl mx-auto text-center animate-slide-up">
          ...
          {/* Hero Headline */}
          <h1 className="hero-premium-title text-5xl md:text-6xl lg:text-7xl font-bold mb-6 leading-tight">
          ...
          {/* Subheadline */}
          <p className="hero-premium-subtitle text-xl md:text-2xl text-muted-foreground mb-12 max-w-2xl mx-auto leading-relaxed">
          ...
          {/* Advanced Search Bar */}
          <div className="hero-search-shell bg-card border border-border shadow-2xl rounded-2xl p-3 md:p-4 max-w-5xl mx-auto backdrop-blur-xl">
            <div className="hero-search-grid grid grid-cols-1 md:grid-cols-12 gap-3">
              {/* Location Search */}
            ...
            {/* Quick Stats */}
            <div className="hero-stats-grid grid grid-cols-3 gap-4 mt-6 pt-6 border-t border-border">
          ...
          {/* Quick Links */}
          <div className="hero-popular-links flex flex-wrap items-center justify-center gap-3 mt-8">
